...
# Montamos static solo si existe la carpeta para evitar que truene el servidor
...
async def ver_perfil():
    ...
    # Si la foto local no está en el servidor, usamos una silueta temporal para que no truene la app
